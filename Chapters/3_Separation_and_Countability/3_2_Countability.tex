...
\begin{boxdefinition}[Compactification]
    Given a space $X$, we say that $X$ has the ``compactification'' $Y$ if there is a space $Y$ such that the following hold:
    \begin{enumerate}
...
\begin{boxdefinition}[One-Point Compactification]
    ...
    \end{enumerate}
    We call $Y$ the \textbf{one-point compactification of $X$}.
\end{boxdefinition}
...
Look up Stone-Čech Compactification...
