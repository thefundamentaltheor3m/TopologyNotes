...
\begin{boxdefinition}[The Topology of Pointwise Convergence]
...
\subsection{Topology of Uniform Convergence}
...
\begin{boxdefinition}[The Uniform Metric/Topology]
    ...
    \end{align*}
    We call the induced topology the \textbf{uniform topology}.
\end{boxdefinition}
